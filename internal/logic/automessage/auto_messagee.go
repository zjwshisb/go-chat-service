...
func (s *sAutoMessage) Update(ctx context.Context, message *entity.CustomerChatAutoMessages, req *backend.AutoMessageUpdateReq) (id int64, err error) {
...
func (s *sAutoMessage) Save(ctx context.Context, req *backend.AutoMessageStoreReq) (id int64, err error) {
