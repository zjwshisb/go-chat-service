...
func (s *sChatSession) Cancel(session *model.CustomerChatSession) error {
...
// Close 关闭会话
func (s *sChatSession) Close(session *model.CustomerChatSession, isRemoveUser bool, updateTime bool) {
...
func (s *sChatSession) Create(ctx context.Context, uid uint, customerId uint, t uint) *entity.CustomerChatSessions {
