...
func (s *sAutoRule) GetActiveByCustomer(customerId int) (items []*relation.CustomerChatAutoRules) {
...
func (s *sAutoRule) GetEnterRule(customerId int) *relation.CustomerChatAutoRules {
	return s.GetSystemOne(customerId, consts.AutoRuleMatchEnter)
}

func (s *sAutoRule) GetEnterRuleMessage(customerId int) *entity.CustomerChatAutoMessages {
...
// GetSystemOne 获取系统规则
func (s *sAutoRule) GetSystemOne(customerId int, match string) *relation.CustomerChatAutoRules {
